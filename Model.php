...
abstract class Model
{
    ...
    public function delete() {
            ...
            $stmt = self::$connection->prepare($delete);
     ...
     /*Model::find($id): accepts the id of a record, and returns an instance of the model class 
        that represents the record with that id*/
